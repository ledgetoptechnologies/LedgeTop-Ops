/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false` (hash: 4e10c0c175019cc59b3e9ca0c60addcf)
...
interface __BaseEnv_Env {
	...
	CLIENT_PORTAL_PROJECTION_INGRESS: Service /* entrypoint OpsSyncPortalProjectionIngress from ltds-clients */;
	OPERATIONS_DELIVERY_INTENT_INGRESS: Service /* entrypoint ProjectAlphaDeliveryIntentIngress from ltds-ops */;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "EXPECTED_HOST" | "TEAM_DOMAIN" | "CF_ACCESS_AUD" | "CF_ACCOUNT_ID" | "CF_ACCESS_GROUP_ID" | "CF_ACCESS_GROUP_NAME" | "APPLICATION_KEY" | "PROJECT_ALPHA_ALLOW_LEGACY_HMAC">> {}
}
