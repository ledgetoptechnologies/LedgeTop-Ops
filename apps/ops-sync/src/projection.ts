...
/** Delivery retries must recover the committed Operations receipt, so an exact
 * completed replay deliberately re-enters the private idempotent RPC after
 * both connector proofs are revalidated. */
