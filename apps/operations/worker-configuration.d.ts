/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false` (hash: 9219261126350047849b91548fb25f7e)
...
interface __BaseEnv_Env {
	...
	THUMBNAIL_RENDERER: DurableObjectNamespace<import("./src/worker/index").ThumbnailRendererContainer>;
	OPS_INVENTORY_CATALOG_STAGING: Service /* entrypoint OpsInventoryCatalogStagingIngress from ledgetop-clients */;
	OPS_INVENTORY_CATALOG_PROMOTION: Service /* entrypoint OpsInventoryCatalogPromotionCoordinator from ledgetop-clients */;
	R2_CRUD_WORKFLOW: Workflow<Parameters<import("./src/worker/index").R2CrudWorkflow['run']>[0]['payload']>;
	INCOMING_LIFECYCLE_WORKFLOW: Workflow<Parameters<import("./src/worker/index").IncomingUploadLifecycleWorkflow['run']>[0]['payload']>;
	INCOMING_RCLONE_PROMOTION_WORKFLOW: Workflow<Parameters<import("./src/worker/index").IncomingRclonePromotionWorkflow['run']>[0]['payload']>;
	DROPBOX_IMPORT_WORKFLOW: Workflow<Parameters<import("./src/worker/index").DropboxImportWorkflow['run']>[0]['payload']>;
	OPS_CATALOG_PROMOTION_WORKFLOW: Workflow<Parameters<import("./src/worker/index").ProjectAlphaCatalogPromotionWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker/index");
		durableNamespaces: "ThumbnailRendererContainer";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_BASE_URL" | "EXPECTED_HOST" | "OPERATIONS_ORIGINS" | "DIRECT_DELIVERY_UPLOADS_ENABLED" | "INCOMING_BASE_URL" | "INCOMING_EXPECTED_HOST" | "INCOMING_RCLONE_PROMOTION_ENABLED" | "ENVIRONMENT" | "TEAM_DOMAIN" | "OPERATIONS_AUD" | "DELIVERY_BASE_URL" | "CLIENT_PORTAL_ORIGINS" | "PUBLIC_SHARE_ORIGIN" | "PROJECT_ALPHA_BASE_URL" | "PROJECT_ALPHA_CONNECTOR_SOURCES_REQUIRED" | "LEGACY_CLIENT_REQUEST_PA_QUOTE_LINK_ENABLED" | "PROJECT_ALPHA_DRAFT_QUOTES_ENABLED" | "PROJECT_ALPHA_API_V2_MONITOR_ENABLED" | "PROJECT_ALPHA_DIRECTORY_RECONCILIATION_ENABLED" | "PROJECT_ALPHA_API_V2_MONITOR_RECIPIENT" | "PROJECT_ALPHA_API_V2_READ_ACCEPTANCE_ENABLED" | "PROJECT_ALPHA_CATALOG_STAGING_COORDINATOR_ENABLED" | "PROJECT_ALPHA_CATALOG_PROMOTION_COORDINATOR_ENABLED" | "PROJECT_ALPHA_PROJECT_V2_ACTIVATION_ENABLED" | "PROJECT_ALPHA_PRIVATE_ADMIN_TRANSPORT_ENABLED" | "NATIVE_DIRECTORY_PROFILE_WRITES_ENABLED" | "NATIVE_DIRECTORY_OUTBOX_DRAIN_ENABLED" | "NATIVE_INTEGRATION_CONTROL_ENABLED" | "CLIENT_ONBOARDING_ADMIN_ENABLED" | "CLIENT_ONBOARDING_ADMIN_ORIGIN" | "NATIVE_INTEGRATION_CONTROL_ORIGIN" | "CLIENT_PORTAL_NOTIFICATION_MIGRATION_MAINTENANCE" | "DELIVERY_SHARE_DIRECTORY_RECIPIENTS_ENABLED" | "CLIENT_DELEGATED_SHARE_SIGNER_ENABLED" | "CLIENT_ONBOARDING_RECIPIENT_BRIDGE_ENABLED" | "CLIENT_PORTAL_HIERARCHY_V2_ENABLED" | "CLIENT_PORTAL_HIERARCHY_RELATIONS_ENABLED" | "CLIENT_PORTAL_MEMBERSHIP_MANAGEMENT_ENABLED" | "PROJECT_ACCESS_AUTHORITY_MUTATIONS_ENABLED" | "CLIENT_PORTAL_IDENTITY_DENYLIST_ENABLED" | "CLIENT_PORTAL_DENY_POLICY_MANAGEMENT_ENABLED" | "CLIENT_PORTAL_ROOT_ACCESS_POLICY_ENABLED" | "CLIENT_PORTAL_OPERATIONS_MANAGEMENT_ENABLED" | "PROJECT_ACCESS_EXPIRY_NOTIFICATIONS_ENABLED" | "AUTHENTICATED_DELIVERY_GRANTS_ENABLED" | "AUTHENTICATED_DELIVERY_CREATION_ENABLED" | "AUTHENTICATED_DELIVERY_NOTIFICATIONS_ENABLED" | "VIEWER_INTEGRATION_ENABLED" | "VIEWER_PROCESSING_ENABLED" | "VIEWER_PUBLIC_SHARES_ENABLED" | "VIEWER_BASE_URL" | "VIEWER_SERVICE_KEY_ID" | "VIEWER_EVENT_KEY_ID" | "VIEWER_EVENT_PREVIOUS_KEY_ID" | "PROJECT_ALPHA_DELIVERY_INTENTS_ENABLED" | "PROJECT_ALPHA_DELIVERY_DIRECT_COMPAT_ENABLED" | "PROJECT_ALPHA_DELIVERY_DIRECT_COMPAT_UNTIL" | "PROJECT_ALPHA_DELIVERY_GUEST_ENABLED" | "CLIENT_PORTAL_PA_IDENTITY_AUTO_ELIGIBILITY_ENABLED" | "CLIENT_PORTAL_WORKSPACE_RECONCILIATION_ENABLED" | "CLIENT_PORTAL_PRIMARY_WORKSPACE_RECONCILIATION_ENABLED" | "CLIENT_HUB_PA_CONTACT_ASSIGNMENTS_ENABLED" | "DEFAULT_UNITS" | "CLIENT_VIEWER_SESSION_ISSUER_ENABLED" | "CLIENT_VIEWER_SHARES_ENABLED" | "APPLICATION_KEY" | "TFR_REGION" | "DISPLAY_TIMEZONE" | "MAP_STYLE_URL" | "STREAM_ACCOUNT_ID" | "STREAM_CUSTOMER_CODE" | "R2_ACCOUNT_ID" | "R2_BUCKET_NAME" | "R2_PURGE_ENABLED" | "R2_INCOMING_BUCKET_NAME" | "FILE_EVENTS_QUEUE_NAME" | "THUMBNAIL_QUEUE_NAME" | "THUMBNAIL_DLQ_NAME" | "THUMBNAIL_INGEST_EXPECTED_HOST" | "THUMBNAIL_RENDERER_EXPECTED_HOST" | "ALERT_FROM" | "ALERT_TO" | "NOTIFICATION_FROM" | "SMTP_NOTIFICATIONS_ENABLED" | "SMTP_HOST" | "SMTP_FROM" | "SMTP_USERNAME" | "CLIENT_REQUEST_TRIAGE_TO" | "DROPBOX_IMPORT_ENABLED" | "DROPBOX_CLIENT_ID">> {}
}
