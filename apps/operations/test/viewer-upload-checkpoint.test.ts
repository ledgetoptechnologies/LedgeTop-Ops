...
import { clearUploadCheckpoint, parseUploadCheckpoint, readUploadCheckpoint, writeUploadCheckpoint } from "../src/client/upload-checkpoint";
...
const valid = {
  ...
  files: [{ id: "file-one", relativePath: "flight/DCIM/IMG_0001.JPG", byteSize: 10, sha256: "b".repeat(64), contentType: "image/jpeg" }],
};
