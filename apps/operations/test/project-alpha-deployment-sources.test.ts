...
function source(sourceId: string, credentialRef: string, profile: "primary_legacy" | "business_data", origin: string) {
  return { sourceId, producerBindingId: sourceId === primary ? "ltds-project-alpha" : "ltt-project-alpha", displayName: sourceId === primary ? "LTDS Project Alpha" : "LTT Project Alpha",
    snapshotOrigin: origin, applicationKey: "ltds_ops", profile, enabled: true, readVisible: true,
