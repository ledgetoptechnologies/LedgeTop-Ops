export type OperationsPage="dashboard"|"operations"|"client-requests"|"sops"|"airspace"|"delivery"|"viewer"|"team"|"configurations"|"administration";
export type OperationsSection="operations"|"projects"|"tasks"|"client-requests";
export type DeliverySection="delivery"|"incoming"|"models";

const PAGES:OperationsPage[]=["dashboard","operations","client-requests","sops","airspace","delivery","viewer","team","configurations","administration"];
...
export function deliverySectionPath(section:DeliverySection):string{
  return section==="models"?"/viewer":section==="incoming"?"/delivery/incoming":"/delivery";
}
