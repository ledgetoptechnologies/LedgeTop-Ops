import { boundedJson, canonicalConnection, date, decimal, diagnostic, endpoint, externalId, exact, get, hash, isFailure, plain, preflightFailure, publicId, runPreflight, trusted, uuid, type ProjectAlphaProjectFailure } from "./project-alpha-project-transport";
...
export type ProjectAlphaProjectBindingStatusOutcome = Readonly<{ status: "observed"; httpStatus: 200; response: ProjectAlphaProjectBindingStatus }> | Readonly<{ status: "not_found" }> | ProjectAlphaProjectFailure;
