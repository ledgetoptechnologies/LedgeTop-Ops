...
export function projectAccessAuthorityMutationsEnabled(env:{PROJECT_ACCESS_AUTHORITY_MUTATIONS_ENABLED?:string}):boolean{
  return env.PROJECT_ACCESS_AUTHORITY_MUTATIONS_ENABLED==='true';
}
