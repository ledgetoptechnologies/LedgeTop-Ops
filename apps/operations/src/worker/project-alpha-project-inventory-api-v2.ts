...
export const PROJECT_ALPHA_PROJECT_INVENTORY_ENDPOINT: Readonly<ProjectAlphaApiV2Endpoint> = Object.freeze(endpoint("GET", "/api/v2/projects/inventory", "projects.inventory.read"));
