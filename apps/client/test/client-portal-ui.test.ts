...
describe("client portal browser API boundary", () => {
  ...
  it("returns native context without a fabricated account or legacy API fallback", async () => {
    ...
    expect(result).toMatchObject({resourceMode: "native", workspace, capabilities: {requestV2: false, feedback: false, viewer: false, workspaceMembershipManagement: true, hierarchyScopedInvitations: true, invitationEmailDelivery: true}, features});
