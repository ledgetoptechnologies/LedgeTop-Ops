...
async function historicalNotificationCursor(secret: string, actor: {issuer: string; subject: string}, version:1|2) {
  ...
  const value = {v: version, scope: 'a'.repeat(64), asOf: '2026-09-06T12:00:00.000Z',
    coverage: {requests: 'included', feedback: 'included'}, water: {requests: 1, feedback: 1},
