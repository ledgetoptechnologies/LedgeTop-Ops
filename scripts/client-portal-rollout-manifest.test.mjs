...
test("rollout manifest is pinned to the current receiver migration boundary", () => {
  for (const migration of [
    ...
    "apps/client/migrations/0199_native_viewer_grants.sql",
    ...
    "apps/client/migrations/0204_delivery_change_receipts.sql",
    "apps/client/migrations/0205_authenticated_delivery_change_sequence.sql",
    "apps/client/migrations/0206_delivery_index_provider_identity.sql",
    "apps/client/migrations/0207_delivery_change_projection.sql",
    "apps/client/migrations/0208_authenticated_delivery_change_batch_provider_identity.sql",
    "apps/client/migrations/0209_authenticated_delivery_change_recipient_events.sql",
    "apps/client/migrations/0210_client_delegated_share_expiry_health.sql",
    "apps/client/migrations/0211_incoming_upload_verification_lifecycle.sql",
    "apps/client/migrations/0212_incoming_upload_archive_inventory.sql",
    "apps/client/migrations/0213_incoming_rclone_promotion.sql",
