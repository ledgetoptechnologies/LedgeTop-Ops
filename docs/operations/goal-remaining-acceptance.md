...
| 5: project memory and field use | Project-owned plans/outcomes/observations, immutable revisions, guarded manager editing, and migration `0047` private manager staff uploads with exact R2 integrity and recovery are verified locally. Operation-owned Job Briefs remain separate. | Apply `0047`, publish and complete live field acceptance. Crew contribution authority remains unapproved; manager uploads do not grant crew editing or client delivery. |
